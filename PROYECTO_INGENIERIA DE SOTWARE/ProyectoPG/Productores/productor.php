...
<head>
    ...
    <link rel="stylesheet" href="regispro.css">
    <title>Inicio</title>
    <style>
...
<body>
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="../Productos/nuevoModal.php" class="btn btn-success">Registrar productos</a>
            <a href="../CatalogoPro/Catalogo.php" class="btn btn-warning">Catálogo</a>
        </div>
